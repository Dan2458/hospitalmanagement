...
public class PatientsController : ControllerBase
{
    ...
    public async Task<IActionResult> Admit(Guid id)
    {
        ...
        return Ok(new { Message = "Patient admitted successfully." });
    }
    ...
    [HttpPost("{id:guid}/bill")]
    public async Task<IActionResult> AddBill(Guid id, [FromBody] decimal amount)
    {
        var result = await _mediator.Send(new AddBillCommand(id, amount));
    ...
    [HttpPost("{id:guid}/payment")]
    public async Task<IActionResult> PayBill(Guid id, [FromBody] decimal amount)
    {
        var result = await _mediator.Send(new PayBillCommand(id, amount));
